...
const base =
  'inline-flex h-10 items-center justify-center gap-1 rounded-xl px-4 text-sm font-bold whitespace-nowrap cursor-pointer ' +
...
// Visual "pressed" feedback (bg darken, shadow drop) fires only on :active (real click),
// never on :hover — hover keeps the resting look.
